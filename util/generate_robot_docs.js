...
function generateCapabilityLink(capability) {
    return "[" + capability + "](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/usage/capabilities-overview.md#" + capability + ")";
}
...
const HIDDEN_IMPLEMENTATIONS = [
    "RoborockM1SNoCloudRobot",
    "RoborockS6MaxVNoCloudRobot",
    "DreameP2149NoCloudRobot",
    "DreameL10SProNoCloudRobot",
    "DreameS10PlusNoCloudRobot",
    "DreameL10UltraNoCloudRobot",
    "DreameD9ProPlusNoCloudRobot",
];
...
Object.keys(vendors).filter(v => v !== "NoCloud").sort().forEach((vendor, i) => {
    let vendorTocEntry = [
