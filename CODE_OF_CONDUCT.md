...
1. Do not act against the interest of, or with lack of care for, the NoCloud mission
...
The one outstanding detail/bug/feature of this CoC is that it **depends** on Hypfer to be reasonable and/or be at least open to reason.
...
NoCloud is not built with that assumption... because it's a fork of Valetudo that isn't either.<br/>
You can read more about Valetudo stance [in the "Contingency" section of the FAQ](https://valetudo.cloud/pages/faq/#what-is-the-contingency-plan-for-valetudo).
...
Essentially, the question Hypfer is asking here is "Laws are nice, but who enforces them and why and how even?"<br/>
...
The point Hypfer is trying to make here is that this ruleset isn't necessarily "different" but just "later" in the sense of the state of a system with these parameters, having the "normal" ruleset and then also having went through all the implications and consequences of a hypothetical conflict.<br/>
... or so is his foundational belief at least. Which, while not universal, is at least rooted in a career built on understanding systems.
...
What greatly confuses Hypfer though is why people would argue/believe that the inversion would be a sane stance.
