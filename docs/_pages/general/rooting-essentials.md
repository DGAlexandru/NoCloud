...
To find the correct rooting instructions for your specific model of robot, check out the [supported robot](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/supported-robots.md) page.
...
at least annoy the people supporting other NoCloud users in their free time.

Thus, to safely root your robot and install NoCloud, you will need prior knowledge in:
...
nearest computer repair shop for help as teaching these basics is beyond the scope of the NoCloud docs.

It's also not feasible to explain every piece of knowledge required in the NoCloud docs, since different people
...
NoCloud rooting instructions expect you to run some **GNU+Linux distribution** such as Debian, Fedora, Arch, Ubuntu or similar.
...
This means deploying NoCloud, figuring some way of running it on system start, modifying the vendor software so that it stops talking to the cloud and more
