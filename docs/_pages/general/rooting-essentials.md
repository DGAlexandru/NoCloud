...
To find the correct rooting instructions for your specific model of robot, check out the [supported robot](https://NoCloud.cloud/pages/general/supported-robots.html) page.
