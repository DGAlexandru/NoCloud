...
This page shall help you start using NoCloud. Make sure that you've read the [newcomer guide](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/newcomer-guide.md).
If you haven't done that already please do so and then come back here.

Please read the [Why NoCloud?](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/why-NoCloud.md) and [Why not NoCloud?](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/why-not-NoCloud.md)
...
To not waste all that hard-earned money, please make sure to thoroughly read the [buying supported robots](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/buying-supported-robots.md)
docs page.
...
now start following the rooting instructions for your [supported robot](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/supported-robots.md).
...
If you're still facing issues connecting to NoCloud, you can also use the [android companion app](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/companion_apps/NoCloud_companion.md)
...
If you don't know how to find said Webinterface, you can use the [android companion app](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/companion_apps/NoCloud_companion.md),
...
It is strongly recommended to now connect NoCloud to the home automation system of your choice such as [Home Assistant](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/integrations/home-assistant-integration.md).
...
Or maybe you're interested in [importing your floor plan into minecraft or the source game engine](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/companion_apps/fun_games.md)?