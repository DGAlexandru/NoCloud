...
## Table of Contents
1. [What is NoCloud?](#what_is_NoCloud)
2. [Who is NoCloud for?](#who_is_NoCloud_for)
3. [What can NoCloud do?](#what_can_NoCloud_do)
4. [Which robot should I buy to use it with NoCloud?](#which_robot)
5. [How do I install NoCloud?](#how_to_install)
6. [Where can I get support?](#get_support)


## What is NoCloud?<a id='what_is_NoCloud'></a>
...
Furthermore, NoCloud allows you to connect your robot to your home automation system without having to detour through a vendor cloud, which,
...
## Who is NoCloud for?<a id='who_is_NoCloud_for'></a>
...
This is in part because anything else wouldn't scale, but also, because NoCloud doesn't just aim to free your robot,
...
The goal of NoCloud is to provide people not with **solutions** but with **agency**.

## What can NoCloud do?<a id='what_can_NoCloud_do'></a>

NoCloud aims to be a generic abstraction, providing a responsive webinterface that allows control of the robot.
...
Additionally, since NoCloud takes all the proprietary vendor map data format and turns those into a unified NoCloudMap format,
...
or Source-Engine maps](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/companion_apps/fun_games.md). Some people have also sent out their robot to map out a new living space before moving,
...
## Which robot should I buy to use it with NoCloud?<a id='which_robot'></a>

NoCloud "just works" because every robot it runs on has been bought and tested by myself.
...
In turn, it however also means that to use NoCloud, you will have to buy one of the supported robots.
...
## How do I install NoCloud?<a id='how_to_install'></a>

The [getting started guide](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/getting-started.md) is a good place to start.
...
If you're stuck, I'm happy to help. As established in the "Who is NoCloud for?" section above, however, the help provided will be that of a peer.
...
There's also the option of using the [GitHub Discussions feature](https://github.com/DGAlexandru/NoCloud/discussions/categories/q-a-support), however, most problems are actually best resolved
