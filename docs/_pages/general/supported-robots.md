...
- [OTA (before 2020-03)](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#ota)
- [Vinda (after 2020-03)](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#vinda)
...
- [UART](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/dreame.md#uart)
...
After that, you will have to reconfigure Wi-Fi using NoCloud.


If NoCloud doesn't want to auto-detect the robot, and it was made around 08/2025 or later, Dreame might've switched to negative
...
6. `reboot`
7. Ensure that NoCloud has now auto-detected the correct implementation and can talk to the robot via the miio stack
...
- [OTA](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#ota)
...
- [Vinda (before 2020-06)](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#vinda)
- [Init override (after 2020-06)](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#init)
...
- [FEL](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#fel)
...
- [Vinda](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/roborock.md#vinda)
...
- [ADB](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/installation/midea.md#adb)
...
mDNS does not work reliably on this robot, meaning that the NoCloud Companion app does not see it.<br/>
⚠⚠⚠
