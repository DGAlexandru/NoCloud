...
**Important note:**<br/>
Because Congas use a non-miio cloud implementation, getting them to work with NoCloud means reflashing them to a Viomi V6.
...
**Important note:**<br/>
Because Proscenic robots use a non-miio cloud implementation, getting them to work with NoCloud means reflashing them to a Viomi V6.
That's possible, because the hardware is exactly the same.
...
**Important note:**<br/>
Because Commodore robots use a non-miio cloud implementation, getting them to work with NoCloud means reflashing them to a Viomi V6.
That's possible, because the hardware is exactly the same.
