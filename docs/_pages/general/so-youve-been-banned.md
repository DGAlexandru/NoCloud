...
<i>Yes, Hypfer sucks. He is a terrible person. He is evil, vile, and manipulative.</i><br/>
<i>An undeserved autocrat incapable of communication.</i><br/>

You're probably here because you were banned and your emotions are completely warranted.<br/>
No one should be forced to deal with someone like Hypfer.

<i>In fact, he wouldn't want to deal with himself either.</i><br/>
What an insane amount of work for some stupid robot vacuum that is supposed to just work.

Here's how you can get rid of Hypfer and strip him of all his dictatorial might:<br/>
...
I bet you can come up with even more ideas than Hypfer could ever do.<br/>
...
<i>Hypfer just parasitically sits here, because he inserted himself into the sorry vendor situation to benefit from it;</i><br/>
<i>Purely motivated by ego and monetary reasons.</i>

Put him in his place!<br/>
Change the world and make what he does irrelevant!
...
If your messages keeps vanishing, chances are that that's also the automod. The code and with that its ruleset is available on GitHub:<br/>
[https://github.com/Hypfer/easterwave](https://github.com/Hypfer/easterwave/)

If it's not the screen name/username nor the automod, it might've been Hypfer.<br/>
In that case, refer to:
1. [The Code of Conduct](https://github.com/DGAlexandru/NoCloud/blob/main/CODE_OF_CONDUCT.md)
2. [Why not NoCloud?](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/general/why-not-valetudo.md)
3. [The FAQ](https://github.com/DGAlexandru/NoCloud/blob/main/docs/_pages/faq.md)
4. [The Contributing.md](https://github.com/DGAlexandru/NoCloud/blob/main/CONTRIBUTING.md)
5. Your local priest
...
It is possible and likely that your intent was misunderstood; either by Hypfer or maybe also by yourself.<br/>
This is one of the many downsides of the ruthless push for efficiency in our current world.

Most bans in Hypfer's space expire after a while, because Hypfer firmly believes that few things are final and it can always get better.<br/>
Some are permanent, though. Though, the CoC _does_ leave the possibility of an appeal _if_ you can find it.


Rest assured, <i>Hypfer absolutely fucking hates this role and would love nothing more than not having to play it.</i><br/>
