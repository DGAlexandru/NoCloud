...
import { getScaledConfusedPlaceholderDog } from "../components/res/NoCloudgPlaceholder";
import { NoCloudAPIBaseURL, Capability } from "../api";
import { useDuststreamingPropertiesQuery, useDuststreamingConfigurationQuery } from "../api";

const STREAM_URL = `${NoCloudAPIBaseURL}/robot/capabilities/${Capability.Duststreaming}/stream`;
...
export const DuststreamCanvas = ({
    ...
    React.useEffect(() => {
        ...
        const options: JSMpegOptions = {
            ...
            createRenderer: (o) => new CRTCompositor(o, {label: "NoCloud"})
        };
