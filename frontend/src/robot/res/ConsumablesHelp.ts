...
At some point, they will become depleted, requiring you to do maintenance and reset them in the NoCloud UI.
...
Still, NoCloud recommends manual inspection of the part in question. You _may_ be able to use it longer than the manufacturer recommends.
