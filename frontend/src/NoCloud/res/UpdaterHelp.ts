...
The NoCloud updater is a convenience feature aiming to make life with NoCloud a bit easier.
...
It is also worth noting that the updater won't update the robots firmware. It only updates the NoCloud binary.
