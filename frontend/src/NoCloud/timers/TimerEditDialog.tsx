...
const actionControls: Record<
    NoCloudTimerActionType,
    React.ComponentType<TimerActionControlProps>
> = {
    [NoCloudTimerActionType.FULL_CLEANUP]: FullCleanupActionControls,
    [NoCloudTimerActionType.SEGMENT_CLEANUP]: SegmentCleanupActionControls,
};

const preActionControls: Record<
    NoCloudTimerPreActionType,
    React.ComponentType<TimerPreActionControlProps>
> = {
    [NoCloudTimerPreActionType.FAN_SPEED_CONTROL]: FanSpeedControlPreActionControl,
    [NoCloudTimerPreActionType.WATER_USAGE_CONTROL]: WaterUsageControlPreActionControl,
    [NoCloudTimerPreActionType.OPERATION_MODE_CONTROL]: OperationModeControlPreActionControl,
};
            ...
            <DialogContent>
                ...
                <FormControl>
                    ...
                    <Select
                        ...
                        onChange={(e) => {
                            const newTimer = deepCopy(editTimer);
                            newTimer.action.type = e.target.value as NoCloudTimerActionType;
