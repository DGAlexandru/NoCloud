...
To operate, they require the system time to be synced using the NTP client built into NoCloud.
...
Timers in NoCloud are provided as a convenience feature.<br/>
