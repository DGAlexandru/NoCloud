...
export const timerActionLabels: Record<NoCloudTimerActionType, string> = {
    [NoCloudTimerActionType.FULL_CLEANUP]: "Full cleanup",
    [NoCloudTimerActionType.SEGMENT_CLEANUP]: "Segment cleanup",
};
