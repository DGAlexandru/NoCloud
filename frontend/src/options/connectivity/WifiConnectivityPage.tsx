...

            {
                ...
                >
                    <Typography color="info">
                        To connect your robot to a different Wi-Fi network, you need to do a Wi-Fi reset and then configure the new one using NoCloud.
                        ...
                        If it is anything more special than that, you should find / seek guidance in the manual what came with your robot, from the vendor.
                        <br/><br/>
