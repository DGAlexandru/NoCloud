        ...
        <>
            ...
            >
                <Typography color="info">
                    To allow quick autodiscovery by the companion apps (also Windows), NoCloud advertises its presence on your
                    local network using mDNS/Bonjour and SSDP/UPnP.
                    It is not recommended to disable this feature, as it will break integration with and/or usage of those companion apps.
                    <br/><br/>
                    ...
                    They are, however, optional, as you just need to know the IP of the robot to talk with NoCloud.
                    You can get that from your router&apos;s webinterface and then create a browser bookmark for it.
                </Typography>
            </InfoBox>
