        ...
        <>
            ...
            >
                <Typography color="info">
                    NoCloud recommends the use of the Eclipse Mosquitto MQTT Broker, which is FOSS, has a
                    ...
                    NoCloud will not receive any feedback from the broker if publishing fails due to ACL restrictions
                    as such feedback
