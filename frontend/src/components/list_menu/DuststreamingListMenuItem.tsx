                ...
                <div className={style.reactMarkDown}>
                    ...
                    >
                        <Typography color="info">
                            <strong>Note</strong>: The slight clunkiness of this feature is not an oversight but by-design.<br/>
                            NoCloud could easily be doing all this for you, but then it would be a one-button, no-thinking, no-skillcheck spycam.<br/>
                            <br/>
                            ...
                            <br/>
                            For more information and additional thoughts, check out the <a target="_blank" rel="noreferrer" href="https://github.com/DGAlexandru/NoCloud/releases/tag/2026.09.04">2026.09.04 release notes</a>, featuring the first release of this functionality.<br/>
                        </Typography>
                    </InfoBox>
