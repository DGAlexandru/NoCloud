...
export interface NoCloudEventRenderProps {
    ...
    interact(interaction: NoCloudEventInteraction): void;
}
...
const ConsumableDepletedEventControl: FunctionComponent<NoCloudEventRenderProps> =
    ({event, interact}) => {
...
const ErrorEventControl: FunctionComponent<NoCloudEventRenderProps> =
    ({event, interact}) => {
...
const PendingMapChangeEventControl: FunctionComponent<NoCloudEventRenderProps> =
    ({event, interact}) => {
        const color = event.processed ? "textSecondary" : "textPrimary";
        const textStyle = event.processed ? {textDecoration: "line-through"} : {};
...
const CreateDismissableEventControl = (message: string) : FunctionComponent<NoCloudEventRenderProps> => {
