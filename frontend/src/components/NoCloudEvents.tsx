...
import {useNoCloudEventsInteraction, useNoCloudEventsQuery} from "../api";
import {eventControls} from "./NoCloudEventControls";
import ReloadableCard from "./ReloadableCard";
import styles from "./NoCloudEvents.module.css";

const NoCloudEvents = (): React.ReactElement => {
    const {
        data: eventData,
    ...
    } = useNoCloudEventsQuery();
    const {mutate: interactWithEvent} = useNoCloudEventsInteraction();
