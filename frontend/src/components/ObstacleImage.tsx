...
import { Capability, useObstacleImagesPropertiesQuery, NoCloudAPIBaseURL } from "../api";
import { getScaledConfusedPlaceholderDog } from "./res/NoCloudgPlaceholder";
...
const ActualObstacleImage = (props: { id: string }): React.ReactElement => {
    ...
    const [imageSrc, setImageSrc] = React.useState(`${NoCloudAPIBaseURL}/robot/capabilities/${Capability.ObstacleImages}/img/${props.id}`);
