...
class NoCloudRobotFactory {
    ...
    static getRobotImplementation(config) {
        ...
        if (robotConfig.implementation === "auto") {
            if (config.get("embedded") === true) {
                return NoCloudRobotFactory.autodetectRobotImplementation();
            } else {
    ...
    static autodetectRobotImplementation() {
        ...
        if (matchedImplementation) {
            ...
            throw new Error("Couldn't find a suitable NoCloudRobot implementation.");
        }
    }
}

module.exports = NoCloudRobotFactory;
