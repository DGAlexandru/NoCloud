const NoCloudBasedCapability = require("./NoCloudBasedCapability");
const NotImplementedError = require("../NotImplementedError");

/**
 * @template {import("../NoCloudRobot")} T
 * @extends NoCloudBasedCapability<T>
 */
class DuststreamingCapability extends NoCloudBasedCapability {
    /**
