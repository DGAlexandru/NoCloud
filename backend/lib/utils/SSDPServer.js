...
class SSDPServer {
     ...
     * to make NoCloud show up in the network tab of the Windows explorer
     *
    ...
    start() {
        ...
        this.socket.on("listening", () => {
            ...
            /*
                ...
                as otherwise NoCloud simply won't receive the UDP packages
             */
        ...
        this.socket.on("message", (msg, rinfo) => {
            if (msg.includes("M-SEARCH") && msg.includes("ST: upnp:rootdevice")) {
                ...
                const response = [
                    ...
                    `SERVER: NoCloud/${Tools.GET_NoCloud_VERSION()} UPnP/1.1`,
                    `LOCATION: http://${this.ip}:${this.webserverPort}/_ssdp/NoCloud.xml`,
