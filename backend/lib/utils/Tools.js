...
class Tools {
    ...
    static async GET_SYSTEM_STATS() {
        ...
        return {
            mem: {
                ...
                NoCloud_current: process.memoryUsage.rss(),
                NoCloud_max: process.resourceUsage().maxRSS * 1024
            },
            load: {
                "1": normalizedLoad[0],
                "5": normalizedLoad[1],
    ...
    static GET_ZEROCONF_HOSTNAME() {
        return "NoCloud-" + Tools.GET_HUMAN_READABLE_SYSTEM_ID().toLowerCase() + ".local";
    }
...
const NoCloud_NAMESPACE = "be5f1ffc-c150-4785-9ebb-08fcfe90c933";
