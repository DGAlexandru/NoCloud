...
const NoCloudManualMovementVector = require("../../entities/core/NoCloudManualMovementVector");
            ...
            switch (req.body.action) {
                ...
                case "move":
                    if (
                        ...
                        try {
                            await this.capability.manualControl(new NoCloudManualMovementVector({
