...
class NoCloudRouter {
    ...
    initRoutes() {
        ...
        this.router.get("/version", (req, res) => {
            res.json({
                release: Tools.GET_NoCloud_VERSION(),
        ...
        this.router.put("/config/interfaces/mqtt", this.validator, (req, res) => {
            let mqttConfig = NoCloudRouter.MAP_MQTT_CONFIG(req.body);
        ...
        this.router.get("/config/customizations", (req, res) => {
            ...
            res.json(NoCloudConfig.customizations);
        });

        this.router.put("/config/customizations", this.validator, (req, res) => {
            if (typeof req.body.friendlyName === "string") {
                const NoCloudConfig = this.config.get("NoCloud");
                NoCloudConfig.customizations.friendlyName = req.body.friendlyName;
                this.config.set("NoCloud", NoCloudConfig);
    ...
    initSSE() {
        ...
        Logger.onLogMessage((line) => {
             ...
             * Everything else using SSE in NoCloud is a single-line string
             *
