...
class RobotMqttHandle extends MqttHandle {
     ...
     * @param {string} options.baseTopic Base topic for NoCloud
    ...
    constructor(options) {
        ...
        this.NoCloudEventsHandle = new NoCloudEventsNodeMqttHandle({
            parent: this,
            controller: this.controller,
            robot: this.robot,
            NoCloudEventStore: this.NoCloudEventStore
        });
        this.registerChild(this.NoCloudEventsHandle);
     ...
     *
     * @public
     * @return {null|NoCloudEventsNodeMqttHandle}
     */
    getNoCloudEventsHandle() {
        return this.NoCloudEventsHandle;
    }
}
