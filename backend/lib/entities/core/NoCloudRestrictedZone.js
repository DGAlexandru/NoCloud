 ...
 */
class NoCloudRestrictedZone extends SerializableEntity {
    /**
     * A ┌───┐ B
     *   │   │
     * D └───┘ C
     ...
     * @param {NoCloudRestrictedZoneType} options.type
...
/**
 *  @typedef {string} NoCloudRestrictedZoneType
 *  @enum {string}
 *
 */
NoCloudRestrictedZone.TYPE = Object.freeze({
    REGULAR: "regular",
    MOP: "mop"
});

module.exports = NoCloudRestrictedZone;
