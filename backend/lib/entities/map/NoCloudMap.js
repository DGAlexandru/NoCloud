 ...
 *
 */
class NoCloudMap extends SerializableEntity { //TODO: Current, Historic, Etc.
    /**
     *
    ...
    /**
     * @public
     * @return {Array<NoCloudMapSegment>}
     */
    getSegments() {
        return this.layers
            .filter(e => {
    ...
    static DESERIALIZE(mapData) {
        ...
        return new NoCloudMap(mapData);
    }
}

module.exports = NoCloudMap;
