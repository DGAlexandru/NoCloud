...
/**
 * @extends VoicePackManagementCapability<import("../RoborockNoCloudRobot")>
 */
    ...
    async getVoicePackOperationStatus() {
        ...
        if (res[0]) {
            switch (res[0].state) {
                case 0:
                case 2:
                    statusOptions.type = NoCloudVoicePackOperationStatus.TYPE.IDLE;
                    break;
                case 1:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    statusOptions.type = NoCloudVoicePackOperationStatus.TYPE.ERROR;
                    break;
                default:
...
const VOICEPACK_ID_TO_COUNTRY_CODE_MAPPING = {
    ...
    2: "tw",
    3: "en",
    10000: "va" //custom. therefore using this unassigned country code for NoCloud :)
};
