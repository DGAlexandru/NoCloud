...
/**
 * @extends ConsumableMonitoringCapability<import("../RoborockNoCloudRobot")>
 */
class RoborockConsumableMonitoringCapability extends ConsumableMonitoringCapability {
    /**
     *
     * @param {object} options
     * @param {import("../RoborockNoCloudRobot")} options.robot
        ...
        switch (this.dockType) {
            case RoborockConst.DOCK_TYPE.ULTRA:
                consumables.push(
                    ...
                    new NoCloudConsumable({
                        type: NoCloudConsumable.TYPE.BIN,
                        subType: NoCloudConsumable.SUB_TYPE.DOCK,
                        remaining: {
...
const CONSUMABLE_TYPE_MAP = Object.freeze({
    [NoCloudConsumable.TYPE.BRUSH]: {
        [NoCloudConsumable.SUB_TYPE.MAIN]: "main_brush_work_time",
        [NoCloudConsumable.SUB_TYPE.SIDE_RIGHT]: "side_brush_work_time",
        [NoCloudConsumable.SUB_TYPE.DOCK]: "cleaning_brush_work_times"
    },
    [NoCloudConsumable.TYPE.FILTER]: {
        [NoCloudConsumable.SUB_TYPE.MAIN]: "filter_work_time",
        [NoCloudConsumable.SUB_TYPE.DOCK]: "strainer_work_times"
    },
    [NoCloudConsumable.TYPE.CLEANING]: {
        [NoCloudConsumable.SUB_TYPE.SENSOR]: "sensor_dirty_time"
    },
    [NoCloudConsumable.TYPE.BIN]: {
        [NoCloudConsumable.SUB_TYPE.DOCK]: "dust_collection_work_times"
    }
});
