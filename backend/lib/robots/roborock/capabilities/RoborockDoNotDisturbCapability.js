...
/**
 * @extends DoNotDisturbCapability<import("../RoborockNoCloudRobot")>
 */
class RoborockDoNotDisturbCapability extends DoNotDisturbCapability {
    ...
    /**
     * NoCloud aims to use UTC only and leave timezone conversion stuff to the frontend.
     ...
     * 
     * Therefore, the timezone needs to be set correctly (out of scope for NoCloud!) and
