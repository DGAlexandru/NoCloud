...
class Dreame1CNoCloudRobot extends DreameNoCloudRobot {
    /**
     *
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.DreameWaterUsageControlCapability({
            robot: this,
            presets: Object.keys(DreameNoCloudRobot.WATER_GRADES).map(k => {
                return new NoCloudSelectionPreset({name: k, value: DreameNoCloudRobot.WATER_GRADES[k]});
            }),
            siid: MIOT_SERVICES.VACUUM_2.SIID,
                ...
                case MIOT_SERVICES.VACUUM_2.SIID: {
                    switch (elem.piid) {
                        ...
                        case MIOT_SERVICES.VACUUM_2.PROPERTIES.WATER_USAGE.PIID: {
                            let matchingWaterGrade = Object.keys(DreameNoCloudRobot.WATER_GRADES).find(key => {
                                return DreameNoCloudRobot.WATER_GRADES[key] === elem.value;
                            });
...
module.exports = Dreame1CNoCloudRobot;
