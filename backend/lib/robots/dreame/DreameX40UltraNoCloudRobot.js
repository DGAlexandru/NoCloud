...
class DreameX40UltraNoCloudRobot extends DreameGen4NoCloudRobot {
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.DreameMapSegmentMaterialControlCapability({
            ...
            supportedMaterials: [
                ...
                capabilities.DreameMapSegmentMaterialControlCapability.MATERIAL.LOW_PILE_CARPET,
                capabilities.DreameMapSegmentMaterialControlCapability.MATERIAL.MEDIUM_PILE_CARPET,
        ...
        [
            ...
            capabilities.DreameMopGapControlCapability,
        ...
        this.registerCapability(new QuirksCapability({
            ...
            quirks: [
                ...
                //quirkFactory.getQuirk(DreameQuirkFactory.KNOWN_QUIRKS.MATERIAL_DIRECTION_CLEANING),				//"2bb060c6-b8fb-41e6-962c-f42036d4ca54" : ["On", "Off"]
    ...
    static IMPLEMENTATION_AUTO_DETECTION_HANDLER() {
        ...
        return [
            "dreame.vacuum.r2416",  // International / Base X40 Ultra model
            "dreame.vacuum.r2416a", // EU X40 Ultra
            "dreame.vacuum.r2416c", // US X40 Ultra
            "dreame.vacuum.r2416h", // X40 Ultra
            "dreame.vacuum.r2416n", // X40 Ultra
...
module.exports = DreameX40UltraNoCloudRobot;
