...
class DreameNoCloudRobot extends MiioNoCloudRobot {
    /**
     *
    ...
    setEmbeddedParameters() {
        this.deviceConfPath = DreameNoCloudRobot.DEVICE_CONF_PATH;
        this.tokenFilePath = DreameNoCloudRobot.TOKEN_FILE_PATH;
    }
        ...
        this.state.subscribe(
            new CallbackAttributeSubscriber((eventType,attachment, prevStatus) => {
                if (
                    ...
                    try {
                        this.NoCloudEventStore.setProcessed(MopAttachmentReminderNoCloudEvent.ID);
                    } catch (e) {
                        //intentional
                    }
                }
...
DreameNoCloudRobot.DEVICE_CONF_PATH = "/data/config/miio/device.conf";
DreameNoCloudRobot.TOKEN_FILE_PATH = "/data/config/miio/device.token";

DreameNoCloudRobot.STATUS_MAP = Object.freeze({
    0: {
...
DreameNoCloudRobot.WATER_GRADES = Object.freeze({
 ...
 */
DreameNoCloudRobot.MAP_ERROR_CODE = (vendorErrorCode) => {
    const parameters = {
        severity: {
...
module.exports = DreameNoCloudRobot;
