...
/**
 * @extends MapAnnotationsCapability<import("../DreameNoCloudRobot")>
 */
class DreameMapAnnotationsCapability extends MapAnnotationsCapability {
    ...
    /**
     *
     * @param {Array<NoCloudMapAnnotation>} mapAnnotations
    ...
    async setMapAnnotations(mapAnnotations) {
        ...
        for (const type of this.supportedAnnotationTypes) {
            switch (type) {
                case NoCloudMapAnnotation.TYPE.CURTAIN: {
                ...
                case NoCloudMapAnnotation.TYPE.RAMP: {
                ...
                case NoCloudMapAnnotation.TYPE.THRESHOLD: {
                    if (dreamePayload.vws === undefined) {
                        dreamePayload.vws = {};
                    }
