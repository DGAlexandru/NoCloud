...
/**
 * @extends MapSegmentMaterialControlCapability<import("../DreameNoCloudRobot")>
 */
    ...
    async setMaterial(segment, material) {
        ...
        switch (material) {
            ...
            case DreameMapSegmentMaterialControlCapability.MATERIAL.TILE:
                mappedMaterial = 2;
                break;
            case DreameMapSegmentMaterialControlCapability.MATERIAL.MEDIUM_PILE_CARPET:
                mappedMaterial = 5;
                break;
            case DreameMapSegmentMaterialControlCapability.MATERIAL.LOW_PILE_CARPET:
                mappedMaterial = 6;
                break;
