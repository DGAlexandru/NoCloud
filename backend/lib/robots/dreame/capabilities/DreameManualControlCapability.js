...
/**
 * @extends ManualControlCapability<import("../DreameGen2NoCloudRobot")>
 */
class DreameManualControlCapability extends ManualControlCapability {
    ...
    /**
     * @param {import("../../../core/capabilities/ManualControlCapability").NoCloudManualControlMovementCommandType} movementCommand
     * @returns {Promise<void>}
     */
    ...
    async sendRemoteControlCommand(velocity, angle, audioHint) {
        this.robot.miotHelper.writeProperty(
            ...
            Logger.debug("Error sending Remote Control Command", e);
        });
