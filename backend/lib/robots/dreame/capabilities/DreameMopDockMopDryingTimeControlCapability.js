...
/**
 * @extends MopDockMopDryingTimeControlCapability<import("../DreameNoCloudRobot")>
 */
class DreameMopDockMopDryingTimeControlCapability extends MopDockMopDryingTimeControlCapability {
    ...
    async getDuration() {
        ...
        switch (res) {
            case 1:
                return DreameMopDockMopDryingTimeControlCapability.DURATION.ONE_HOUR;
            case 2:
    ...
    async setDuration(newDuration) {
        ...
        switch (newDuration) {
            case DreameMopDockMopDryingTimeControlCapability.DURATION.ONE_HOUR:
                val = 1;
                break;
    ...
    getProperties() {
        return {
            supportedDurations: [
                DreameMopDockMopDryingTimeControlCapability.DURATION.ONE_HOUR,
