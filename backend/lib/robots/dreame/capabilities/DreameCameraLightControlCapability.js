...
/**
 * @extends CameraLightControlCapability<import("../DreameNoCloudRobot")>
 */
class DreameCameraLightControlCapability extends CameraLightControlCapability {
    ...
    async isEnabled() {
        ...
        return deserializedResponse.FillinLight === 1;
    }
...
module.exports = DreameCameraLightControlCapability;
