/**
 * @typedef {import("../../../entities/core/NoCloudVirtualRestrictions")} NoCloudVirtualRestrictions
 */
...
class DreameCombinedVirtualRestrictionsCapability extends CombinedVirtualRestrictionsCapability {
    ...
    /**
     *
     * @param {NoCloudVirtualRestrictions} virtualRestrictions
    ...
    async setVirtualRestrictions(virtualRestrictions) {
        ...
        virtualRestrictions.restrictedZones.forEach(zone => {
            ...
            switch (zone.type) {
                case NoCloudRestrictedZone.TYPE.REGULAR:
                    destination = dreamePayload.rect;
                    break;
                case NoCloudRestrictedZone.TYPE.MOP:
