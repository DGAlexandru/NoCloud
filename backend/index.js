...
const NoCloud = require("./lib/NoCloud");

const noCloud = new NoCloud();

/*
    This is the easiest and most complete Mitigation against CWE-1321 Prototype Pollution
    We do that after new NoCloud() to not interfere with any (library) code.
...
// (e.g. kill command, service noCloud stop, reboot (via upstart),...)
