...
describe("NoCloudEventStore", () => {
    describe("rehydrateEvents", () => {
        it("correctly reconstructs standard events from a serialized JSON representation", () => {
            ...
            assert.ok(evt1 instanceof DustBinFullNoCloudEvent);
            ...
            assert.ok(evt2 instanceof NoCloudRuntimeErrorNoCloudEvent);
            assert.strictEqual(evt2.reason, NoCloudRuntimeErrorNoCloudEvent.REASONS.MEMORY_USAGE);
            ...
            assert.ok(evt3 instanceof ConsumableDepletedNoCloudEvent);
        ...
        it("gracefully ignores unknown event classes", () => {
            ...
            assert.ok(rehydratedEvents[0] instanceof DustBinFullNoCloudEvent);
